...
Simply install latest [Julia](https://julialang.org) for Linux and MacOS. For more functionailty and flexibility you can try the python fork [jill.py](https://github.com/johnnychen94/jill.py)
